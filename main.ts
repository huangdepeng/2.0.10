...
namespace hicbit {
  ...
  /**
    ...
    * Get the obstacle avoidance sensor status,1 detect obstacle,0 no detect obstacle
     ...
     */
    //% weight=84 blockId=hicbit_lineSensorValue1 block="Get line follower sensor Value|port %port|value(0~255)"
    ...
    */
    ...
    /**
    * Get the ad value of the photosensitive moudule 光敏
    */
    ...
    */
    //% weight=83 blockId=hicbit_getavoidSensorValue  block="Get avoid Sensor Value|port %port|value(0~255)"
    ...
    */
    //% weight=16 blockId=hicbit_collisionsensor block="collision sensor|port %port|is trigger"    
